...
# -----------------------
# 👗 NEW: Style Keywords (إضافة بدون حذف القديم)
# -----------------------
STYLE_KEYWORDS = {
    "كاجوال": [
    ...
    "أنيق": [
        "dress", "white dress", "elegant", "formal",
        "standing outside", "fashion", "maroon dress"
    ],
    ...
    "ستايل شاطئ": [
        ...
        "sun", "vacation", "outdoor"
    ],
    
    "كيوت": [
      "little girl","cute", "pink","child","kid","smiling", "soft colors"
    ],
    "رياضي": [
...
# -----------------------
# تحليل الموضة الذكي (Hybrid + Upgrade)
# -----------------------
...
if "little girl" in text:
    ...
    improvements.append("إضافة ألوان مرحة أو إكسسوارات ناعمة")

    style_scores["كيوت"] = 9
   # -----------------------
    # 🔥 NEW: Style Detection (Scoring)
    # -----------------------
    ...
    # -----------------------
    # gender signals (بدون تغيير منطقي كبير)
    # -----------------------
    ...
    # -----------------------
    # 📊 NEW: إضافة تحليل الستايل النهائي
    # -----------------------
