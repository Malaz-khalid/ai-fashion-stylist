...
def fashion_analysis(description):
    ...
    if any(w in text for w in ["woman", "man"]):
        points.append("إطلالة شخصية واضحة ومباشرة")
    ...
    if any(w in text for w in ["dress"]):
        style = "إطلالة أنيقة"
        score += 2
