...
def load_model():
    ...
    # 🔥 FIX 1: يقلل الاستهلاك ويمنع crashes
    model.eval()
...
def fashion_analysis(description):
    ...
    # -----------------------
    # Cute detection (مهم بدون تغيير باقي النظام)
    # -----------------------
    ...
    if "dress" in text and style != "كيوت":
        ...
        improvements.append("اطلالة رائعة كاملة")
    ...
    if not points:
        ...
        improvements.append("اضافة اكسسوارات")
    ...
    if st.button("تحليل الإطلالة"):
        ...
        with st.spinner("جاري التحليل الذكي..."):
            ...
            with torch.no_grad():
                ...
                # 🔥 FIX 2: تقليل الحمل (بدون تغيير النتيجة)
